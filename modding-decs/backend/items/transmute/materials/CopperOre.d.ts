...
declare class CopperOre extends Item {
    getId(): string;
    getTags(): ItemTagEnum[];
    getPicture(): any;
...
export declare const copperOre: CopperOre;
declare class TransmuteCopperOre extends TransmutationSpell {
    getItem(): Item;
...
export declare const transmuteCopperOre: TransmuteCopperOre;
export {};
